...
public class CatalogoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recycler2 = findViewById(R.id.recyclerCatalogo);
        recycler2.setHasFixedSize(true);
        recycler2.setLayoutManager(new LinearLayoutManager(this));

        db2 = FirebaseFirestore.getInstance();
        listProductos2 = new ArrayList<ProductosCar>();
        myAdapter2 = new MyAdapter2(CatalogoActivity.this,listProductos2);
    ...
    private void EvenChangeListener() {
        ...
        db2.collection("PRODUCTOS").orderBy("nombre", Query.Direction.ASCENDING)
